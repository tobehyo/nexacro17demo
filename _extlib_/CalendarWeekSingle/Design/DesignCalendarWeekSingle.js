...
{
    var _pCalendarWeekSingle = nexacro.CalendarWeekSingle.prototype;

    /*
    // Metainfo의 Default 값과 별개로 기본으로 세팅해줘야 할 Property를 세팅한다.
    // (taborder는 designform에서 직접 설정한다)
    */
    _pCalendarWeekSingle._initDesignDefaultProperty = function ()
    {
        // TODO :
    };
    ...
    */
    _pCalendarWeekSingle.createCssDesignContents = function ()
    {
        // TODO :
    };
