...
{
    var _pCalendarWeekDouble = nexacro.CalendarWeekDouble.prototype;

    /*
    // Metainfo의 Default 값과 별개로 기본으로 세팅해줘야 할 Property를 세팅한다.
    // (taborder는 designform에서 직접 설정한다)
    */
    _pCalendarWeekDouble._initDesignDefaultProperty = function ()
    {
        // TODO :
    };
    ...
    */
    _pCalendarWeekDouble.createCssDesignContents = function ()
    {
        // TODO :
    };
