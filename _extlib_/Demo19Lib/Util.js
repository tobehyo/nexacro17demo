...
*******************************************************************************
 ...
 ● gfnIsNexaComponent			: nexacro Component 여부
 ...
 ● gfnConvertXY				: Component 기준의 XY좌표를 XCompA 기준의 XY좌표로 변환.
 ● gfnGetScrollLeft			: 수평스크롤바의 trackbar 위치를 반환한다
 ● gfnGetScrollTop				: 수직스크롤바의 trackbar 위치를 반환한다
 ● gfnCopyProperties			: object에 argument로 주어진 object의 모든 속성값을 복사한다.
 ● gfnGetSequenceId			: Form 내에서 지정된 접두문자열에 순번이 붙여진 ID 를 반환
 ● gfnEach						: object 속성값들을 주어진 함수로 처리한다.
 ...
 ● gfnIsYMD					: 날짜 여부를 확인한다.(8자리)
 ● gfnIsYM						: 날짜 여부를 확인한다.(6자리)
 ● gfnIsTime					: 시간 형식에 맞는지 Check 한다.
 ● gfnGetDate					: 현재일자를 구한다. (date/null : 일자, time : 일자+시간, milli : Milliseconds)
 ...
 ● gfnCallGA					: Google Analytics 호출한다.
 ● gfnGetFriendlyUrl			: 문자를 원하는 형태로 치환한다.
...
************************************************************************************************/
/**
* gfnCallGA : Call Google Analytics TrackEvent
* @param {String}  category		- 카테고리
* @param {String}  action		- 이벤트
* @param {String}  opt_label	- 라벨명
* @return : N/A
* @example :  
*/

pForm.gfnCallGA = function(category, action, opt_label) 
{	
	var categoryUrl = this.gfnGetFriendlyUrl(category);
	var actionUrl = this.gfnGetFriendlyUrl(action);
	var optlabelUrl = this.gfnGetFriendlyUrl(opt_label);
	
	var page = "/" + categoryUrl + "/" + optlabelUrl;
...
/**
* gfnGetFriendlyUrl : function to urlify a string.
* @param {string} str 대상 문자열.
* @return {string} url 친화적 문자열.
* @example :  
*/
pForm.gfnGetFriendlyUrl = function(str)
{
...
/**
* on_start : function to Transaction Overriding.
* @param {} 
* @return {} 
* @example :  
*/
...
/**
* on_load_data : function to Transaction Overriding.
* @param {} 
* @return {} 
* @example :  
*/
...
/**
* on_load_datamodule : function to Transaction Overriding.
* @param {} 
* @return {} 
* @example :  
*/
