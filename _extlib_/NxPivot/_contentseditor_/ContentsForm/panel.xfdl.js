(function()
{
    return function()
    {
        ...
        this.createPanelComp = function(){
        	...
        	this.createItems(objPanel, panel, "fields");
        	this.createItems(objPanel, panel, "colAxis");
        	this.createItems(objPanel, panel, "rowAxis");
        	this.createItems(objPanel, panel, "values");
        ...
        this.createItems = function(objPanel,panel,items){
        	...
        	if(this.isEmpty(objItems)==false){
        		if(items=="toolbar"){
        			...
        			if(this.isEmpty(objItems.items.title)==false){
        				...
        				objItemComp = this.createComp(objItem, objItemsComp);
        			}
        ...
        this.createComp = function(objItem,objParent){
        	var objComp;
